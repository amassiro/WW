...
// #include "test/WW/ttbar/plotUtils.C"
...
//  int _debug = 4;
 ...
 std::string inputDirectory = "output_Latinos_tree_2012_2orMoreJet2012";
 std::string fileSamples = "test/WW/ttbar/datacard/SamplesH.txt";
...
//  v_commonCut_WW.push_back("(bveto_ip==1 && nbjettche==0)");
 ...
 //---- >=2 jets and central jets
 v_commonCut_WW.push_back("njet >= 2");
 v_commonCut_WW.push_back("abs(jeteta1)<2.5");
 v_commonCut_WW.push_back("abs(jeteta2)<2.5");
 ...
 //---- Top enriched phase space 
 std::vector <std::string> v_TopEnrichedCut_WW;
 v_TopEnrichedCut_WW.push_back("(!sameflav)");
 v_TopEnrichedCut_WW.push_back("sqrt(2)*sqrt(((((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))*((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))+abs(jeteta1-eta1)*abs(jeteta1-eta1))<(((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))*((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))+abs(jeteta2-eta1)*abs(jeteta2-eta1)))*(2*pt1*jetpt1*(cosh(eta1-jeteta1)-cos(phi1-jetphi1)))+((((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))*((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))+abs(jeteta1-eta1)*abs(jeteta1-eta1))>(((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))*((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))+abs(jeteta2-eta1)*abs(jeteta2-eta1)))*(2*pt1*jetpt2*(cosh(eta1-jeteta2)-cos(phi1-jetphi2))))<250");
 v_TopEnrichedCut_WW.push_back("sqrt(2)*sqrt(((((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))*((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))+abs(jeteta1-eta1)*abs(jeteta1-eta1))<(((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))*((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))+abs(jeteta2-eta1)*abs(jeteta2-eta1)))*(2*pt1*jetpt1*(cosh(eta1-jeteta1)-cos(phi1-jetphi1)))+((((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))*((abs(jetphi1-phi1)>3.14159265)*(2*3.14159265-abs(jetphi1-phi1))+(abs(jetphi1-phi1)<3.14159265)*(abs(jetphi1-phi1)))+abs(jeteta1-eta1)*abs(jeteta1-eta1))>(((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))*((abs(jetphi2-phi1)>3.14159265)*(2*3.14159265-abs(jetphi2-phi1))+(abs(jetphi2-phi1)<3.14159265)*(abs(jetphi2-phi1)))+abs(jeteta2-eta1)*abs(jeteta2-eta1)))*(2*pt1*jetpt2*(cosh(eta1-jeteta2)-cos(phi1-jetphi2))))>50");
 std::string TopEnrichedCut_WW = Compact(v_TopEnrichedCut_WW);
 ...
 if (whatAnalysis == "cut") {
  v_commonCut_Higgs.push_back("mll>70"); //---- Higgs removal
  v_commonCut_Higgs.push_back("(mth>40 || sameflav)"); //---- DYtt removal in of
 }
...
//  etaBins.push_back (1.5);
 ...
 int nBin_MAX = nBin ; //---- jeteta < 2.5 -> no problem with last bin!
 ...
 ///---- bjetprob added ----
 ///---- inversion of both tche and jetpb cut
 ///--- AB
 zoneCut.push_back("(nbjettche==0 && jetbjpb1<0.5 &&  jetbjpb2<0.5)        ||         ( ((nbjettche==1 && (((abs(jeteta1)<abs(jeteta2))  && (jettche1>2.10)) || ((abs(jeteta1)>=abs(jeteta2)) && (jettche2>2.10))))   &&     ( (((abs(jeteta1)<abs(jeteta2))  && (jetbjpb1>0.5 && jetbjpb2<0.5)) || ((abs(jeteta1)>=abs(jeteta2)) && (jetbjpb2>0.5 && jetbjpb1<0.5))) )) )");
 ///--- B
 zoneCut.push_back("                                                                    ((nbjettche==1 && (((abs(jeteta1)<abs(jeteta2))  && (jettche1>2.10)) || ((abs(jeteta1)>=abs(jeteta2)) && (jettche2>2.10))))   &&     ( (((abs(jeteta1)<abs(jeteta2))  && (jetbjpb1>0.5 && jetbjpb2<0.5)) || ((abs(jeteta1)>=abs(jeteta2)) && (jetbjpb2>0.5 && jetbjpb1<0.5))) )) ");
 ///--- A
 zoneCut.push_back("nbjettche==0 && jetbjpb1<0.5 &&  jetbjpb2<0.5");
 ...
 TString nameFileInEff = Form ("test/WW/ttbar/result-eff-%s-%s.txt",whatAnalysis.c_str(),suffix.c_str());
 ...
 else
 {
  ...
  TString nameFileOutEff = Form ("test/WW/ttbar/result-eff-%s-%s.txt",whatAnalysis.c_str(),suffix.c_str());
 ...
 for (int iBin=0; iBin<nBin; iBin++) {
  ...
  TString nameFileOutEffHiggs = Form ("test/WW/ttbar/result-eff-%s-%s-%d.txt",whatAnalysis.c_str(),suffix.c_str(),iWP);
...
//   std::cout << "; err_DD_Top = " << (err_DD_Top.at(0)).at(iBin) << std::endl;
 ...
 if (Ncontrol != 0) {
  ...
  std::cout << " Alpha      = " << Alpha        << " = " <<     DD_totalTop << " / " << Ncontrol << std::endl;
  std::cout << " err_Alpha  = " << err_Alpha    << " = " << err_DD_totalTop << " / " << Ncontrol << std::endl;
 ...
 TString nameFileOut = Form ("test/WW/ttbar/result-%s-%s-%d.txt",whatAnalysis.c_str(),suffix.c_str(), iWP);
...
//  myfileAll                   << mH[iWP]                << "   " ;
 ...
 nameFileOut = Form ("test/WW/ttbar/result-SF-%s-%s-%d.txt",whatAnalysis.c_str(),suffix.c_str(), iWP);
 std::cout << " cat " << nameFileOut.Data() << std::endl;
 std::cout << std::endl;
